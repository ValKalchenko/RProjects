...
# use table function to create a freuency table for
...
# table for a categorical variable (percentage)
...
# use quantile funtion to calculate specific quantiles
# for a quantitative variable
# may provide 1 specific quantile for multiple quantiles
...
# clear variable from global enviornment
rm(list = ls())
